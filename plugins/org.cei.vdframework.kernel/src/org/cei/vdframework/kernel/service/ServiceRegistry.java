...
public class ServiceRegistry {
	 ...
	 */
	protected static String VD_SERVICE_EXTENSION_POINT_ID = "org.vdframework.kernel.service";
	...
	public void loadServices(IExecutionEngine engine) {
		...
		IConfigurationElement[] configurations = registry.getConfigurationElementsFor(VD_SERVICE_EXTENSION_POINT_ID);
