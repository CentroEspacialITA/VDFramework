...
public class HierarchicalState extends Context {
    ...
    boolean dispatch(Metadata data, Event event, Parameter parameter) {
        ...
        /*
         * If the substate dispatched the event and we reached the finalstate or
         * this state is no longar active, trigger a new dispatch for the end
         * transition, otherwise return.
         */
        ...
        /*
         * If no substate can handle the event try to find a transition on this
         * state which can. There are 3 possibilities: - The endstate is
         * reached: Call the finishing transition - Handle the event with a
         * transition from this state - Handle the event with a transition
        ...
        for (int i = 0; i < transitions.size(); i++) {
            ...
            /*
             * If the endstate is active and the transition is a finishing
             * transition (it has not event), trigger the transition without the
             * event.
             * 
