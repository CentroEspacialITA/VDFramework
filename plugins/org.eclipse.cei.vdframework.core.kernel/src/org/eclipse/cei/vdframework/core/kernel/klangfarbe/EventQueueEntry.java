...
public class EventQueueEntry implements Runnable, Delayed {
    ...
    /*
     * FIXME The behaviour of this Method is a bit strange in order to handle a
     * bug in JDK 5. If used in JDK 6 or newer this method can be changed so
     * that it only compares the absoluteTimeout.
     */
    @Override
