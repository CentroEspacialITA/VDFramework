...
/**
 * Describes a transition which does not change the state when triggered, but
 * only executes the associated action. This kind of transition must have an
 * event as its trigger. In contrast to the normal transition the states entry
 * and exit actions are not triggered.
 */
